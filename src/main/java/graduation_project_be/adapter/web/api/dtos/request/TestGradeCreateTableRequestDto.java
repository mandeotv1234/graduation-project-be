...
public record TestGradeCreateTableRequestDto(
        String correctQuery,
        String studentQuery,
        Object gradingRubric,
        Double totalPoints) {

    public TestGradeCreateTableRequest toRequest(ObjectMapper objectMapper) {
        String rubric = toRubricJson(gradingRubric, objectMapper);
        return new TestGradeCreateTableRequest(
