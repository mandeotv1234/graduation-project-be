...
public record TestGradeRoutineRequestDto(
        String correctQuery,
        String studentQuery,
        Object gradingRubric,
        Double totalPoints) {

    public TestGradeRoutineRequest toRequest(Long examId, ObjectMapper objectMapper) {
        String rubric = toRubricJson(gradingRubric, objectMapper);
        return new TestGradeRoutineRequest(
                examId,
